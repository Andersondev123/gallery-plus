...
export const DialoTrigger = DialogPrimitive.Trigger;
    ...
    <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content ref={ref} className={cn(`
           fixed left-[50%] top-[50%] w-full max-w-[32rem] z-[60] 
            translate-x-[-50%] translate-y-[-50%] data-[state=open]:fade-in-0 
            data-[state=open]:animate-in data-[state=open]:slide-in-from-bottom-[48%]
            data-[state=close]:animate-out
            data-[state=close]:fade-out-0 
            data-[state=close]:slide-out-from-bottom-[48%]
        `,className)}{...props}>
