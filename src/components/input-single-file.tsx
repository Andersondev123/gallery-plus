        ...
        <div className="w-full relative group cursor-pointer">
            ...
            <div className="flex flex-col gap-1 mt-1">
                ...
                {formFile && !isValidSize() && 
                    <Text variant="label-small" className="text-accent-red">O tamanho do arquivo ultrapassa o máximo</Text>
                }
            {error && (<Text variant="label-small" className="text-accent-red">{error}</Text>)}</div></>)
            ...
            (
                ...
                border border-solid border-border-primary mt-5 p-3 rounded`}>
                 <Icon svg={FileImageIcon} className="fill-white w-6 h-6 "/>
                    ...
                    <div className="flex flex-col ">
                        ...
                        <div className="flex">
                        <button type="button" className={textVariants({variant:"label-small", 
