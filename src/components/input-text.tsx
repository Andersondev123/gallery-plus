...
export const inputTextVariants = tv({
    base: `
    bg-trasparent outline-none placeholder:text-placeholder text-accent-paragraph
    flex-1
    `
});
...
{icon?: React.ComponentProps<typeof Icon>["svg"], error?: React.ReactNode;}

export default function InputText({size, disabled, error, className, icon, ...props}: InputTextProps){
       return(
